...
public class MainActivity extends Activity {
    ...
    private static final String CONSUMER_KEY = "1572235510";// 替换为开发者的appkey，例如"  966056985";
...
//调用api
                   /* StatusesAPI api = new StatusesAPI(MainActivity.accessToken);
                    api.update("为毛换个号就好了。干。。。", "90.00", "90.00", new RequestListener() {
                   ...
                   */
                    ...
                    UsersAPI users = new UsersAPI(MainActivity.accessToken);
                    users.show("2263464151", new RequestListener() {
						...
						public void onComplete(String response) {
							// TODO Auto-generated method stub
							Log.d("pengfei", "users "+response);
						}
					});
                    
                    StatusesAPI statuses = new StatusesAPI(MainActivity.accessToken);
                    statuses.publicTimeline(100, 2, true, new RequestListener() {
